...
INSTALLED_APPS = [
    'trackflight.apps.TrackflightConfig',
    'rest_framework',
    'drf_yasg',
...
DATABASES = {
    'default': {
        ...
        'NAME': os.environ.get('MYSQL_DATABASE', default='trackingFlightDatabase'),
        'USER': os.environ.get('MYSQL_USER', default='root'),  # changed to '' -> 'root'
...
REST_FRAMEWORK = {
    ...
    'EXCEPTION_HANDLER': 'trackflight.error_handling.custom_exception_handler',
}
